...
KAC=[cl,ki,kk,kc,kd,ke,kf,kg,kh,kj,kl,km,kn,ko,kp,kq]
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid]
...
#===========================================
        ...
        if op.type == 25:
               ...
               if wait["wblack"] == True:
            ...
            elif msg.text.lower() == 'Pinvite on':
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text.lower() == 'Pinvite off':
			...
			kc.sendText(msg.to,cmid)
                ...
                kl.sendText(msg.to,"PŚĎ ßoŤ 10 +🛃 􀜁􀅔Har Har􏿿")
                km.sendText(msg.to,"PŚĎ ßoŤ 11 +🛃 􀜁􀅔Har Har􏿿")
                kn.sendText(msg.to,"PŚĎ ßoŤ 12 +🛃 􀜁􀅔Har Har􏿿")
                ko.sendText(msg.to,"PŚĎ ßoŤ 13 +🛃 􀜁􀅔Har Har􏿿")
                kp.sendText(msg.to,"PŚĎ ßoŤ 14 +🛃 􀜁􀅔Har Har􏿿")
                kq.sendText(msg.to,"PŚĎ ßoŤ 15 +🛃 􀜁􀅔Har Har􏿿")
...
#========================================
            ...
            elif msg.text in ["PJoinn on","pjoinn on"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["PJoinn off","pjoinn off"]:
              if msg.from_ in admin:
